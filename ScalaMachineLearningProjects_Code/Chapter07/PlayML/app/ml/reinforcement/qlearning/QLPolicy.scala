 ...
 * Version 0.99.2
 */
package ml.reinforcement.qlearning

import ml.Predef.DblPair
 ...
 */
final  class QLData(val reward: Double, val probability: Double = 1.0) {
  import QLDataVar._
...
final  class QLPolicy(val input: Seq[QLInput]) {
  import QLDataVar._
